    ...
    <footer className="bg-white shadow-2xl text-black py-12">
      <div className="container mx-auto px-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <div>
            <div className="mb-4">
            <p className="mb-2 text-xl font-semibold">Contact Person - <span className="font-medium">Mr. Arnab Paul</span></p>
            <div className="flex justify-center"><div className="bg-black h-[1px] w-2/3"></div></div>
            </div>
            <p className="mb-2">
            ...
            <p className="mb-2">+91-9319644055</p>
          ...
          <div>
            ...
            <div className="flex">
              <input
                ...
                className="w-full p-3 text-gray-900 border bg-white rounded-l-md focus:outline-orange-700"
              />
