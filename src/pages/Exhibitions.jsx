      ...
      <div className="max-w-8xl mx-auto px-8 py-12">
        ...
        <div className="mb-8">
          <div className="flex gap-4 py-2">
            <button className="bg-red-500 px-16 text-white text-md font-semibold rounded-sm py-3 cursor-pointer hover:bg-red-600 transition">
              Videos
            </button>
            <button className="bg-gray-400  px-16 text-white text-md font-semibold rounded-sm py-3 cursor-pointer hover:bg-red-600 transition">
              Images
            </button>
          </div>
