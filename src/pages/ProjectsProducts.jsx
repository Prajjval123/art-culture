...
const dummyProducts = [
  ...
  },
  {
    ...
    title: "Product 2",
    description:
      "Abstract Mild Steel Sculpture installed at Aurobindo Marg New Delhi, India. Desgining ,modelling, Fabrication is done by our Artists in our worshop.",
      ...
      <div className="max-w-8xl mx-auto px-8 py-12">
        ...
        <div className="flex justify-center mb-6">
          <div className="flex space-x-4 py-4 px-24 rounded-lg w-full">
            <select
              className="p-2 border border-gray-300 rounded min-w-2xs "
              style={{
                backgroundImage:
                  "src/assets/projectproducts/dropdown/dropdown-svg.svg",
            ...
            />
            <button className="p-2 bg-red-500 text-white rounded min-w-24">
              Search
            </button>
            <button className="p-2 bg-gray-300 text-black rounded min-w-24">
              Reset
            </button>
          </div>
        </div>
